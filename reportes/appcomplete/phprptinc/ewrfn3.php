...
function ValidateUser($Username, $Password) {
	global $conn;
	$ValidateUser = FALSE;
	$AdminUsername = EW_REPORT_ADMIN_USER_NAME;
	$AdminPassword = EW_REPORT_ADMIN_PASSWORD;
	if (EW_REPORT_CASE_SENSITIVE_PASSWORD) {
	...
	if ($ValidateUser) {
		...
		$_SESSION[EW_REPORT_SESSION_SYSTEM_ADMIN] = 1; // System Administrator
	}
	return $ValidateUser;
}
