...
define("EW_REPORT_CONN_USER", "root", TRUE);
define("EW_REPORT_CONN_PASS", "", TRUE);
define("EW_REPORT_CONN_DB", "appacademy", TRUE);
...
define("EW_REPORT_RANDOM_KEY", '5f%32gzX#37oQv4_', TRUE); // Random key for encryption
...
// Hard-coded admin
define("EW_REPORT_ADMIN_USER_NAME", "admin", TRUE);
define("EW_REPORT_ADMIN_PASSWORD", "admin", TRUE);

// User admin
define("EW_REPORT_USERNAME_FIELD", "idusuario", TRUE);
define("EW_REPORT_PASSWORD_FIELD", "contrasena", TRUE);
define("EW_REPORT_USERID_FIELD", "", TRUE);
define("EW_REPORT_PARENT_USERID_FIELD", "", TRUE);
define("EW_REPORT_USERLEVEL_FIELD", "", TRUE);
define("EW_REPORT_LOGIN_SELECT_SQL", "SELECT * FROM `usuario`", TRUE);
