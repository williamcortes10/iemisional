  ...
  <body>
		...
		?>
			...
			<?php
					...
					$sqlduplicateentry = "SELECT pc.* FROM plan_curricular pc, estandares e WHERE e.idmateria_fk='$idmateria'AND e.grado='$idaula' AND e.codigo=pc.estandarbc AND  pc.competencia='$desestbc'";
					...
					?>	
						...
						<div class="containertable center-block alert alert-success">
							<h4>Competencia Guardada con exito</h4>
							<p><a class='btn btn-lg btn-success ' href='<?php echo $_SERVER['HTTP_REFERER'];?>' role='button'>Volver</a></p>
						</div>
						<?php					
					}
