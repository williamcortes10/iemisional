...
<html lang="en">
  <head>
    ...
    <title>SISTEMA ACADEMICO DE CALIFICACIONES - CATEGORIZAR COMPETENCIAS</title>
		...
		?>
			...
			<?php
				...
				if($conx->get_numRecords($consulta)>0){
					...
					echo "<caption><h3 style='text-align:center;'>CATEGORIZAR COMPETENCIAS</h3></caption>";
					echo "<thead>";
					echo "<tr>";
					...
					while ($row = $conx->records_array($consulta)) {
						...
						echo "<td><a class='btn btn-info' href='listarcompetenciasseleccionadacat.php?id=$id&idmateria=$idmateria&idaula=$idaula&aniolectivo=$aniolectivo'><span>Ver competencias seleccionadas</span></a></td>";
						echo "</tr>";
					}
					echo "</tbody>";
					echo "</table>";
