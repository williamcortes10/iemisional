		...
		$(document).ready(function(){
			...
			idaula1=$("#idaula").val();
  			...
  			iddocente1=$("#iddocentes").val();
				...
				$.post("buscaraula_response.php",{iddocente:iddocente1, aniolect:aniolect1},function(data){
    					$("#divaula").html(data);
						$("#divaula").fadeIn();
  				});
			...
			$("#formupuser").submit(function(event) {
				...
				aniolect1=$("#aniolect").val();
  				iddocente1=$("#iddocentes").val();
  				$.post("buscar_response.php",{iddocente:iddocente1, idaula:idaula1, aniolect:aniolect1},function(data){
    					$("#result").html(data);
						$("#result").show(1000);
  				});
			  });
