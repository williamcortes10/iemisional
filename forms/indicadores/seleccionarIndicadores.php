...
<html>
    <head>
        <title>Seleccionar Indicadores</title>
		...
		$(document).ready(function(){
			...
			/*if($("#aniolect").val()>2014){
				$("#idmateria").change(function(){
					idmateria1=$("#idmateria").val();
					idaula1=$("#idaula").val();
					//buscar estandares basicos de competencias
					$.post("buscaestandar_response.php",{idmateria:idmateria1, idaula:idaula1},function(data){
							$("#resultlista").fadeOut();
							$("#divestandarbc").fadeOut();
							$("#divestandarbc").html(data);
							$("#divestandarbc").fadeIn();
					});
				});
			}*/
			...
			$("#formbusqueda").submit(function(event) {
				...
				idmateria1=$("#idmateria").val();
  				...
  				$.post("listaindicadores_response.php",{iddocente:iddocente1, idaula:idaula1, idmateria:idmateria1,
				aniolect:aniolect1},function(data){
			 ...
			 $("#formindicadores").submit(function(event) {
				...
				var val = $('#indicadores:checked').map(function(i,n) {
					return $(n).val();
				...
				periodo1=$("#periodo").val();
  				...
  				$.post("guardarindicadores.php",{iddocente:iddocente1, 'indicadores[]':val,
				periodo:periodo1, aniolect:aniolect1},function(data){
    					$("#resultlista").html(data);
						$("#resultlista").show(1000);
						$("#guardar").fadeOut(100);
  				});
	...
	<div class="bg_img"><img src="../../images/1.jpg" alt="background" /></div>
		...
		if($look){
			...
			<h1>Formulario  - Seleccionar Indicadores</h1>
			...
			echo "<input type='hidden' name='aniolecthidden' value='".$aniolect."'>";
			echo "</select>
			<div id='divaula'>
			
			</div>
			<div id='divestandarbc'>
			...
			<div class='content'>
				...
				<div class='saveindicadores'>
					...
					<form id='formindicadores' name='formindicadores' method='post' action=''>
					<p>Seleccione indicadores</p>
					<div id='resultlista'>
					</div>
					<div id='btnindicadores'>
