...
<html>
    <head>
        <title>Des-seleccionar Indicadores</title>
		...
		$(document).ready(function(){
			...
			$("#formbusqueda").submit(function(event) {
				...
				idmateria1=$("#idmateria").val();
  				...
  				$.post("listaindicadoressel_response.php",{iddocente:iddocente1, idaula:idaula1, idmateria:idmateria1,
			 ...
			 $("#formindicadores").submit(function(event) {
				...
				periodo1=$("#periodo").val();
  				...
  				$.post("eliminarindicadores.php",{iddocente:iddocente1, 'indicadores[]':val,
	...
	<div class="bg_img"><img src="../../images/1.jpg" alt="background" /></div>
		...
		if($look){
			...
			<h1>Formulario  - Des-seleccionar Indicadores</h1>
