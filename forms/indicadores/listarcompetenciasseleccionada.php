...
<html lang="es">
  ...
  <body>
		...
		?>
			...
			<form class="form-signin" role="form" action="quitarsucess.php" method='POST' id='frmcompseleccionada' name='frmcompseleccionada'>
			<?php
				
				echo "<h3 style='text-align:center;'>QUITAR COMPETENCIAS SELECCIONADAS</h3> <hr/><h4>".utf8_encode($nommateria)."  GRADO $curso</h4>";
				?>
				<div class="form-group form-inline">
					<label for="periodo">Periodos habilitado para calificar:</label>
					...
					<button type="submit" class="btn btn-primary" id='quitar'>Quitar</button>
				 </div>
