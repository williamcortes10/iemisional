...
if(!$consulta){
	...
	while($data = $conx->records_array_assoc($consulta)){
		...
		echo "<td><button iddocente='".$data['iddocente']."' class='calificar btn btn-success' placeholder='Ingresar calificaciones'><i class='glyphicon glyphicon-edit'></i> Copiar notas</button></td>";
		echo "</tr>";
	}
	if($flag==0){
