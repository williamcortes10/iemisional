...
<html lang="en">
  <head>
    ...
    <title>SISTEMA ACADEMICO DE CALIFICACIONES - INGRESAR CALIFICACIONES NIVELACION</title>
			...
			<?php
				...
				if($conx->get_numRecords($consulta)>0){
					...
					while ($row = $conx->records_array($consulta)) {
						...
						echo "<td><a class='btn btn-primary' href='calificacionesxestudiantenv.php?id=$id&idmateria=$idmateria&idaula=$idaula&aniolectivo=$aniolectivo'><span>Listar estudiantes</span></a></td>";
						echo "</tr>";
					}
					echo "</tbody>";
					echo "</table>";
