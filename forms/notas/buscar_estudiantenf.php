...
<html>
    <head>
        <title>Ingresar Notas Finales</title>
		...
		$(document).ready(function(){
			...
			$("#formbusqueda").submit(function(event) {
				...
				idmateria1=$("#idmateria").val();
  				...
  				$.post("buscar_responsenf.php",{iddocente:iddocente1, idaula:idaula1, idmateria:idmateria1,
			 ...
			 $("#formestudiantes").submit(function(event) {
				...
				var val = $('#idestudiante:checked').map(function(i,n) {
  				...
  				iddocente1=$("#iddocentes").val();
				idaula1=$("#idaula").val();
				$(location).attr('href', 'guardarnotasnf.php?idmateria='+idmateria1+'&aniolect='+aniolect1+'&docente='+iddocente1+'&estudiantes='+val+'&idaula='+idaula1);
			  });
