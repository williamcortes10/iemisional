			...
			<div class="container"><br/><br/>
				...
				<div class="panel panel-danger">
				  <div class="panel-heading">
					<h3 class="panel-title">REPORTE COORDINADORES DE AREAS - AÑO LECTIVO <?php echo $_GET['aniolectivo']; ?></h3>
				  </div>
				  <div class="panel-body">
					<table id="datatable_docentes" class="display" cellspacing="0" width="100%">
						<thead>
							<tr>
								<th>Asignatura</th>
								<th width="250px">Docente</th>
								<th width="150px">Grado</th>
								<th width="150px">Cantidad de Competencias Seleccionadas 1er Corte</th>
								<th width="150px">Cantidad de Competencias Seleccionadas 2do Corte</th>
								<th width="150px">Cantidad de Competencias Seleccionadas 3er Corte</th>
							</tr>
						</thead>
						<tfoot>
							<tr>
		...
		var table = $("#datatable_docentes").DataTable({
			...
			buttons: [
				{ extend: 'excelHtml5', footer: false,
					title: 'REPORTE COORDINADORES DE AREAS - AÑO LECTIVO  <?php echo $_GET['aniolectivo']; ?>',
			...
			"ajax":{
				"method": "GET",
				"url": "lista_coordinadores_todos.php?&aniolectivo=<?php echo $_GET['aniolectivo']; ?>"
			},
			"columns":[
				{"data":"nombre_materia"},
				{"data":"nombre_docente"},
				{"data":"salon"},
				{"data":"comp_seleccionadas1"},
				{"data":"comp_seleccionadas2"},
				{"data":"comp_seleccionadas3"},
