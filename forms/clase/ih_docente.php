			...
			<div class="container"><br/><br/>
				...
				<div class="panel panel-danger">
				  <div class="panel-heading">
					<h3 class="panel-title">REPORTE INTENSIDAD HORARIA <?php echo $_GET['nombre']." - AÑO LECTIVO ".$_GET['aniolectivo']; ?></h3>
				  </div>
		...
		var table = $("#datatable_docentes").DataTable({
			...
			buttons: [
				{ extend: 'excelHtml5', footer: false,
					title: 'REPORTE INTENSIDAD HORARIA <?php echo $_GET['nombre']." - AÑO LECTIVO ".$_GET['aniolectivo']; ?>',
