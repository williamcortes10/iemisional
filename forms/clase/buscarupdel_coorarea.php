  ...
  <body>
		...
		?>
			...
			<div class="container"><br/><br/><br/><br/>
				...
				<h3>Docentes | Coordinadores de áreas | Actualizar/Eliminar</h3>
	...
	var obtener_data_docente = function(tbody, table){
		$(tbody).on("click","button.ver_areas", function(){
			...
			window.location.href = "buscarupdel_coordinador_area.php?idmateria="+data.idmateria+"&aniolectivo="+aniolectivo+"&nombre_materia="+nombre;
		});
	}
	var listar = function() {
		...
		obtener_data_docente("#datatable_areas tbody",table);
