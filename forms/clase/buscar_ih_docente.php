  ...
  <body>
		...
		?>
			...
			<div class="container"><br/><br/><br/><br/>
				...
				<h3>Docentes | Intensidad Horaria | Reporte I.H <button type="button" class="btn btn-primary toda_ih">Ver Toda la I.H</button></h3> 
	...
	var obtener_data_docente = function(tbody, table){
		$(tbody).on("click","button.ver_clases", function(){
			var data = table.row($(this).parents('tr')).data();
			var aniolectivo=$("#aniolectivo").val();
			var nombre=data.apellido1+" "+data.apellido2+" "+data.nombre1+" "+data.nombre2;
			window.location.href = "ih_docente.php?iddocente="+data.iddocente+"&aniolectivo="+aniolectivo+"&nombre="+nombre;
		});
	}
	var listar = function() {
		...
		var table = $("#datatable_docentes").DataTable({
			...
			"columns":[
				...
				{"data":"nombre1"},
				{"data":"nombre2"},
				{"defaultContent":"<button class='ver_clases btn btn-warning' placeholder='Ver I.H'><i class='glyphicon glyphicon-time'></i> Ver I.H</button>"}
			],
	...
	$(document).ready(function() {
		listar();
		$(".toda_ih" ).click(function() {
			var aniolectivo=$("#aniolectivo").val();
			window.location.href = "ih_todos_docente.php?aniolectivo="+aniolectivo;
		});
