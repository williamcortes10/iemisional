  ...
  <body>
	...
	var obtener_data_docente = function(tbody, table){
		$(tbody).on("click","button.ver_clases", function(){
			...
			window.location.href = "buscarupdel_clase_docente.php?iddocente="+data.iddocente+"&aniolectivo="+aniolectivo+"&nombre="+nombre;
		});
	}
	var listar = function() {
		...
		var table = $("#datatable_docentes").DataTable({
			...
			"columns":[
				...
				{"data":"nombre1"},
				{"data":"nombre2"},
				{"defaultContent":"<button class='ver_clases btn btn-success' placeholder='Ver Clases'><i class='glyphicon glyphicon-blackboard'></i> Ver Clases</button>"}
			],
