			...
			<div class="container">
				...
				<nav aria-label="breadcrumb">
				  <ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="#">Intensidad Horaria</a></li>
				  ...
				  <div class="modal-dialog" role="document">
					<div class="modal-content">
					  <div class="modal-header">
						...
						<h4 class="modal-title" id="exampleModalLabel">Asignar Salón</h4>
					  </div>
					  <div class="modal-body">
						<div class="panel panel-danger">
						  <div class="panel-heading">Formulario  - Nueva Clase</div>
						  <div class="panel-body">
							<form role="form" class="form-horizontal" id='formNvClase' name='formNvClase' method='post' action='asignarclase_response.php'>
										...
										<select class="form-control" id="aniolect" name="aniolect">
										 <?php 
											...
											while($data = $conx->records_array_assoc($consulta)){
												echo "<option value='".$data["valor"]."'>".$data["valor"]."</option>";
											}
										 ?>
										</select>
									</div>
	...
	var listar = function() {
		...
		var table = $("#datatable_docentes").DataTable({
			...
			"columns":[
				...
				{"data":"nombre1"},
				{"data":"nombre2"},
				{"defaultContent":"<button class='nuevo btn btn-primary' placeholder='Nueva Clase'><i class='glyphicon glyphicon-blackboard'></i> Nueva Clase</button>"}
			],
