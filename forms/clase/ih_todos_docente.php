  ...
  <body>
		...
		?>
			...
			<div class="container"><br/><br/>
				...
				<h3>Docentes | Intensidad Horaria | Reporte I.H </h3>
				<div class="panel panel-danger">
				  <div class="panel-heading">
					<h3 class="panel-title">REPORTE INTENSIDAD HORARIA - AÑO LECTIVO <?php echo $_GET['aniolectivo']; ?></h3>
				  </div>
		...
		var table = $("#datatable_docentes").DataTable({
			...
			buttons: [
				{ extend: 'excelHtml5', footer: false,
					title: 'REPORTE INTENSIDAD HORARIA  - AÑO LECTIVO  <?php echo $_GET['aniolectivo']; ?>',
			...
			"ajax":{
				"method": "GET",
				"url": "lista_clases_todos.php?&aniolectivo=<?php echo $_GET['aniolectivo']; ?>"
			},
			"columns":[
				{"data":"nombre_docente"},
				{"data":"salon"},
