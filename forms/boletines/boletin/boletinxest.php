...
$sql = "SELECT DISTINCT e.a1, e.a2, e.n1, e.n2, m.grado, e.codest FROM tbestudiante e, tbnotas n, matricula m 
	WHERE e.codest='$codest' AND e.codest=n.codest_fk AND m.grado='$grado' AND e.estado='ACT' AND n.periodo=$periodo AND n.aniolect=$aniolect 
...
<span>
<a href="../../forms/boletin/boletinindividual.php" class="large button orange" style="font-size: 12px !important;">Regresar</a>
</span>
<span>
