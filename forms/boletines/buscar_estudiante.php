...
<html>
    <head>
        <title>GENERAR BOLETIN INDIVIDUAL</title>
 			...
 			$("#result").hide();
  			$("#buscar").click(function( event ) {
				event.preventDefault();
  				txt=$("#txt_filtro").val();
  				$.post("upestudiante_response.php",{str_search:txt},function(data){
    					$("#result").html(data);
						$("#result").show();
  				});
			});
		...
		function generarBoletin(codigo, idaula, aniolectivo){
			$(document).ready(function(){
				...
				location.href='boletinindividual.php?id='+codigo+'&idaula='+idaula+'&aniolectivo='+aniolectivo;	
