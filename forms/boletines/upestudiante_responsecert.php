<?php
	...
	CONCAT_WS(' ',e.nombre1, e.apellido1) LIKE '%".$str_search."%' OR
	CONCAT_WS(' ',e.idestudiante, e.apellido1, e.nombre1, e.nombre2) LIKE '%".$str_search."%' )
	AND e.idestudiante=m.idestudiante AND m.idaula=a.idaula AND m.tipo_matricula='R' AND m.periodo=0 ORDER BY idestudiante DESC";
