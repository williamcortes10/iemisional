...
<html>
	...
	?>
		...
		if($look){
			...
			<form method='POST' action='listado_reprobados.php'>
			...
			<table>";
					...
					if($conx->get_numRecords($consulta)>0){
						echo "<tr><td class='estilocelda' colspan='4'>Informe  - Estudianes</td></tr>";
						while ($row = $conx->records_array($consulta)) {
							...
							WHERE e.idestudiante = m.idestudiante  AND m.tipo_matricula = 'R'
