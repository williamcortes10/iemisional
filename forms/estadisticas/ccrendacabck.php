...
<html lang="es">
	...
	<?php
		...
		if (isset($_SESSION['k_username'])) {
			...
			WHERE idusuario='".$_SESSION['k_username']."' and iddocente=idusuario and (tipousuario='D' OR tipousuario='A' OR tipousuario='C')";
				  ...
				  <div class="panel-body">
					...
					<div class="form-group">
						...
						<select  class="form-control" id='idaula' name='idaula'>";
							...
							while($recordscurso = $conx->records_array($consulta)){
								echo "<option value='".$recordscurso['idaula']."'>".utf8_encode($recordscurso['descripcion']."-G".$recordscurso['grupo']."-".
					...
					<div class="form-group">
						...
						<select  class="form-control" id='grado' name='grado'>";
							...
							while($recordsgrado = $conx->records_array($consulta)){
								echo "<option value='".$recordsgrado['grado']."'>".utf8_encode($recordsgrado['descripcion'])."</option>";
							}
					...
					<div class="form-group">
						...
						<select  class="form-control" id='asignatura' name='asignatura'>";
							...
							while($recordsasignatura = $conx->records_array($consulta)){
								echo "<option value='".$recordsasignatura['idmateria']."'>".utf8_encode($recordsasignatura['nombre_materia'])."</option>";
							}		
					...
					<div class="form-group">
						...
						<select  class="form-control" id='periodo' name='periodo'>
							...
							<option value='s3'>3 Trimestres</option>
				  ...
				  <div class="panel-body">
					...
					<table id="datatable" class="table table-hover">
						...
						while($recordsasig = $conx->records_array($consultaasig)){
							...
							?>
							<tr><td><?php echo utf8_encode($nommateria)?></td>
							<?php
							switch($periodo){
								case 1:
								case 2:
