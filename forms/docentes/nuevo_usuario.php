...
<html lang="en">
  ...
  <body>
			...
			<div class="container">
				  ...
				  <div class="modal fade" id="myModal" role="dialog">
					...
					<nav aria-label="breadcrumb">
					  <ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="#">Información Usuarios</a></li>
				...
				<div class="panel panel-danger">
				  ...
				  <div class="panel-body">
					<form role="form" class="form-horizontal" id='formdocente' name='formdocente' method='post' action='nvusuario_response.php'>
						...
						<div class="form-group">
							<label for="pass" class="col-sm-2 control-label">Contraseña <em style='color:red;'>*</em></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="habilitado" class="col-sm-2 control-label">Habilitar Usuario</label>
							<div class="col-sm-4">
	...
	$(document).ready(function() {
		...
		$.getJSON('lista_docentes.php', function(data) {
			$.each(data.data, function(key, value) {
				$("#idusuario").append('<option value="' + value.iddocente + '">' + value.apellido1 + ' '+value.apellido2 +' '+value.nombre1 +' '+value.nombre2 +' ( CC '+value.iddocente+')'+'</option>');
			}); // close each()
		}); // close getJSON()
	});
	$(document).ready(function() {
