...
<html lang="en">
  <head>
    ...
    <title>SISTEMA ACADEMICO DE CALIFICACIONES - REPORTE DE DOCENTES</title>
    ...
    <link href="../../plugins/validator.io/css/bootstrapValidator.min.css" rel="stylesheet" media="screen">
    <link href="../../plugins/datatables2/buttons.dataTables.min.css" rel="stylesheet" media="screen">
    <link href="../../plugins/datatables2/jquery.dataTables.min.css" rel="stylesheet" media="screen">
			...
			<br/><br/><br/>
				<nav aria-label="breadcrumb">
				  <ol class="breadcrumb">
					...
					<li class="breadcrumb-item active" aria-current="page">Reporte Docentes</li>
				  </ol>
				</nav>
			<div class="panel panel-danger">
			  <div class="panel-heading">
				<h3 class="panel-title">REPORTE DE DOCENTES REGISTRADOS EN EL SISTEMA</h3>
			  </div>
		...
		var table = $("#datatable_docentes").DataTable({
			...
			buttons: [
				{ extend: 'excelHtml5', footer: false,
					title: 'LISTA DE DOCENTES - <?php echo $ie;?>',
