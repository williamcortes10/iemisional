...
<?php
		...
		$sql = "SELECT DISTINCT * FROM aula WHERE idaula = '".$_GET["id"]."'";
    ...
    <head>
		...
		$(document).ready(function(){
			...
			$("#formupuser").submit(function(event) {
				...
				idaula1=$('#idaula').val();
				grado1=$('#grado').val();
				gradoback1=$('#gradoback').val();
				grupo1=$('#grupo').val();
				grupoback1=$('#grupoback').val();
				descripcion1=$('#descripcion').val();
				// Send the data using post and put the results in a div
				$.post( "upaula_sucess.php", {idaula: idaula1, grado: grado1, 
				gradoback: gradoback1, grupo: grupo1, grupoback: grupoback1, descripcion: descripcion1} ,
				  function( data ) {
					  $( "#resultado" ).html( data );
						$("#resultado").show(1000);
	...
	?>
		...
		if($look){
			echo "<div class='form'>
				...
				<h1>Formulario  - Nueva Aula</h1>
				<p>Complete los datos</p>
				<label>Grado
				<span class='small'>Seleccione Grado<span style='color:red'>*</span></span>
				</label>
				...
				echo "</select>
				<label>Grado en letras
				<span class='small'>Asigne un nombre al grado<span style='color:red'>*</span></span>
				</label>
				<input type='text' name='descripcion' id='descripcion' size='20' maxlength='20' value='$descripcion'/>
				<label>Grupo
				<span class='small'>Seleccione Grupo<span style='color:red'>*</span></span>
				</label>
				...
				<input type='hidden' name='gradoback' id='gradoback' value='$grado'/>
				<input type='hidden' name='grupoback' id='grupoback' value='$grupo'/>
