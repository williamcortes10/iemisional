    ...
    <head>
		...
		$(document).ready(function(){
			...
			$("#formupuser").submit(function(event) {
				...
				$.post( "nvaula_response.php", {grado: grado1, grupo: grupo1, descripcion: descripcion1} ,
				  function( data ) {
					  $( "#resultado" ).html( data );
						$("#resultado").show(1000);
	...
	?>
		...
		if($look){
			...
			<div class='form'>
				...
				<input type='text' name='descripcion' id='descripcion' size='20' maxlength='20'/>
				<label>Grupo
        ...
        <div align='center'>
			<span align='center'>
				<a href='notasxasignatura.php' class='large button orange' style='font-size: 12px !important;'><img src='../../images/back.png' id='back' alt='Regresar' /></a>
			</span>
