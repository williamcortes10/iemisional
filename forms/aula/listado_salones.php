...
<html lang="en">
  <head>
    ...
    <title>SISTEMA ACADEMICO DE CALIFICACIONES - REPORTE DE SALONES REGISTRADOS EN EL SISTEMA</title>
			...
			<br/><br/><br/>
				<nav aria-label="breadcrumb">
				  <ol class="breadcrumb">
					...
					<li class="breadcrumb-item active" aria-current="page">Reporte Salones</li>
				  </ol>
				</nav>
			<div class="panel panel-danger">
			  <div class="panel-heading">
				<h3 class="panel-title">REPORTE DE SALONES REGISTRADOS EN EL SISTEMA</h3>
			  </div>
