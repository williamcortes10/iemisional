...
<html>
	...
	?>
		...
		<table class='tabla'>";
				...
				echo "<td>Nro.</td><td>Estudiante</td><td>CODIGO IND</td><td>V.N</td><td>Faltas J</td><td>Faltas S.J</td><td width='50px'>Comportamiento</td><td>Observaciones</td>";
				echo "</tr>";
				$numero=0; 	
				foreach( $estudiantes as $id){
					...
					$sqlind = "SELECT * FROM indicadoresboletin ib WHERE ib.iddocente=$docente 
