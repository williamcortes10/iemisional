...
<html>
    <head>
        <title>ACTUALIZAR NOTAS - NIVELACION</title>
			...
			$("#formbusqueda").submit(function(event) {
			 ...
			 $("#formestudiantes").submit(function(event) {
				...
				periodo1=$("#periodo").val();
  				...
  				iddocente1=$("#iddocentes").val();
				idaula1=$("#idaula").val();
				$(location).attr('href', 'actualizarnotas.php?periodo='+periodo1+'&idmateria='+idmateria1+'&aniolect='+aniolect1+'&docente='+iddocente1+'&estudiantes='+val+'&idaula='+idaula1);
			  });
	...
	<div class="bg_img"><img src="../../images/1.jpg" alt="background" /></div>
		...
		if($look){
			...
			<h1>Formulario  - Actualizar Notas Nivelacion</h1>
