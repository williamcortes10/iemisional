...
<html>
    <head>
        <title> INGRESAR NOTAS NIVELACION- PLANILLA</title>
	...
	?>
		...
		<table class='tabla'>";
				...
				echo "<tr><td class='estilocelda' colspan='4'>Nivelaciones - Ingresar Notas</td></tr>";
				echo "<tr><td>Docente:".$row['nombre1']." ".$row['nombre2']." ".$row['apellido1']." ".$row['apellido2']."</td>
				<td align='right'>Materia:".$row['nombre_materia']."</td></tr>";
