...
<html lang="en">
  <head>
    ...
    <title>SISTEMA ACADEMICO DE CALIFICACIONES - REPORTE DE ASIGNATURAS REGISTRADAS EN EL SISTEMA</title>
			...
			<br/><br/><br/>
				<nav aria-label="breadcrumb">
				  <ol class="breadcrumb">
					...
					<li class="breadcrumb-item active" aria-current="page">Reporte Asignaturs</li>
				  </ol>
				</nav>
			<div class="panel panel-danger">
			  <div class="panel-heading">
				<h3 class="panel-title">REPORTE DE ASIGNATURAS REGISTRADAS EN EL SISTEMA</h3>
			  </div>
