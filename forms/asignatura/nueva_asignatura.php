		...
		?>
			...
			<div class="container">
				...
				<div class="panel panel-danger">
				  <div class="panel-heading">Formulario  - Nuevo Asignatura</div>
				  <div class="panel-body">
					<form role="form" class="form-horizontal" id='formdocente' name='formdocente' method='post' action='nvasignatura_response.php'>
				
						<div class="form-group">
							<label for="iddocente" class="col-sm-2 control-label">Nombre asignatura</label>
							<div class="col-sm-4">
							  <input type="text" class="form-control" name='nombremat' id='nombremat' size='50' maxlength='100' placeholder="Máximo 100 caracteres">
							</div>
						</div>
						<div class="form-group">
