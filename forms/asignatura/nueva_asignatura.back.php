    ...
    <head>
		...
		$(document).ready(function(){
			...
			$("#formupuser").submit(function(event) {
				...
				$.post( "nvasignatura_response.php", {nombremat: nombremat1} ,
				  function( data ) {
					  $( "#resultado" ).html( data );
						$("#resultado").show(1000);
	...
	?>
		...
		if($look){
			...
			<div class='form'>
				...
				<h1>Formulario  - Nueva Asignatura</h1>
				<p>Complete los datos</p>
				<label>Nombre asignatura
				<span class='small'>Maximo 50 caracteres<span style='color:red'>*</span></span>
				</label>
				<input type='text' name='nombremat' id='nombremat' size='50' maxlength='100'/>
